...
public class ChokeholdAutonDoubleArmUpW_GetOutTheWay extends ChokeholdAutonArmUp {
	private String name = "Two side \"Chokehold\", with the arm raised w/ Get Out the Way!";
	
	public ChokeholdAutonDoubleArmUpW_GetOutTheWay() {
		super();
